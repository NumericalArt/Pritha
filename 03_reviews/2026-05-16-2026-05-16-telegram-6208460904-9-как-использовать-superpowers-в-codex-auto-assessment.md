---
id: 2026-05-16-2026-05-16-telegram-6208460904-9-как-использовать-superpowers-в-codex-auto-assessment
type: assessment
status: draft
created: 2026-05-16
updated: 2026-05-16
...
```text
type status path heading snippet ---------- --------- -------------------------------------------------------------------------------------------------------------- ---------------------------- ----------------------------------------------------------------------------------------------------------- workflow active 07_workflows/codex-assisted-signal-extraction.md Codex harness ## [Codex] harness Использовать prompt/spec: ```text 07_workflows/prompts/signal-extraction-harness ... wiki-index generated 10_wiki/index.md Pages ... [tools], security, evals; sources: 5; review: unreviewed - [[pages/tool-[codex]|tool: [codex] ... workflow active 07_workflows/memory-implementation-roadmap.md Phase 1: Markdown discipline ... type`, `status`, `created`, `updated`, `topics`, `[tools]`, `sources`, `related`. - Правило: каждый новый материал ... wiki-page generated 10_wiki/pages/topic-harness-engineering.md Current synthesis ## Current synthesis - From `02_briefs/2026-05-15-harness-engineering-[codex]-agents ...
```

---
id: wiki-page-tool-gpt-realtime-translate
type: wiki-page
status: generated
created: 2026-05-16
updated: 2026-05-16
...
last_linted: 
---
# Wiki Page: tool: gpt-realtime-translate
...
This generated page tracks gpt-realtime-translate as a tool in the Techscope knowledge base. Use it for navigation and synthesis only; follow the sources before making standards or decisions.
...
- [[pages/topic-openai|topic: openai]]
- [[pages/topic-audio-models|topic: audio-models]]
- [[pages/topic-realtime-api|topic: realtime-api]]
- [[pages/topic-voice-agents|topic: voice-agents]]
- [[pages/topic-transcription|topic: transcription]]
- [[pages/topic-translation|topic: translation]]
- [[pages/topic-agent-ux|topic: agent-ux]]
- [[pages/topic-safety|topic: safety]]
- [[pages/tool-openai|tool: openai]]
- [[pages/tool-gpt-realtime-2|tool: gpt-realtime-2]]
- [[pages/tool-gpt-realtime-whisper|tool: gpt-realtime-whisper]]
- [[pages/tool-realtime-api|tool: realtime-api]]
